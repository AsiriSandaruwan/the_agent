...
?>
<header id="header-part" class="mostion clearfix header-style8 sf-header-full-width <?php echo sanitize_html_class($innerheader); ?> <?php echo sanitize_html_class($srhheader); ?>">
  <!-- No top bar header style start -->
  <div class="main-bar clearfix ">
    <div class="container">
        <div class="logo-header mostion">
        ...
        <div class="sf-bnr-text">
            <div class="container"> 
                <div class="sf-bnr-write">
                    <div class="text-top-line"><?php echo (!empty($service_finder_options['banner-heading'])) ? apply_filters('the_content', $service_finder_options['banner-heading']) : ''; ?> </div>
                    <div class="text-bot-line"><?php echo (!empty($service_finder_options['banner-subheading'])) ? apply_filters('the_content', $service_finder_options['banner-subheading']) : ''; ?></div>
                </div>
            </div>
        </div>
    </div>
