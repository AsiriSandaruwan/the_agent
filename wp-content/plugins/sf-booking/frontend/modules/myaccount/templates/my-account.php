        ...
        <div class="col-lg-6">
          <div class="form-group">
            ...
            <div class="input-group"> <i class="input-group-addon fixed-w fa fa-skype"></i>
              <input type="text" class="form-control sf-form-control" name="skypeid" placeholder="<?php esc_html_e('Please enter skype id', 'service-finder'); ?>" value="<?php echo esc_attr($userInfo['skypeid']) ?>">
            </div>
          </div>
        </div>
        <div class="col-lg-6">
