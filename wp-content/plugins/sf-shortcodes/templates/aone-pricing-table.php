...
$subtitle = (!empty($service_finder_options['shortcode-pricing-plans-subtitle'])) ? esc_html($service_finder_options['shortcode-pricing-plans-subtitle']) : '';
...
$subtitlecolor = (!empty($service_finder_options['shortcode-pricing-plans-subtitle-color'])) ? esc_html($service_finder_options['shortcode-pricing-plans-subtitle-color']) : '';
...
ob_start();
?>
<div class="section-full p-t80 p-b50 sf-pricing-wrap sf-curve-pos" <?php echo ($imgurl != '') ? 'style="background:url('.esc_url($imgurl).') center '.esc_attr($bgattachment).' no-repeat;"' : ''; ?>>
    <div class="container">
        ...
        <div class="section-content">
            <div class="sf-pricing-section-outer">
                <div class="row no-gutter">
					...
					?>
					<div class="col-md-3">
                        <div class="sf-pricing-section <?php echo ($highlight == $i) ? 'sf-pricing-active' : ''; ?>">

                            <div class="sf-price-tb-info">
                                <div class="sf-price-plan-name"><?php echo esc_html($packagename); ?></div>
                            ...
                            <div class="sf-price-tb-list">
                                <ul>
									...
									if(!empty($cap_fields))
									{
										...
										$notavailableclass = ($available == 'no') ? 'disable' : '';
										$featuretitle = service_finder_get_data($service_finder_options,'shortcode-pricing-feature-'.$key,$cap_field);
										?>
										<li class="<?php echo sanitize_html_class($notavailableclass); ?>"><i class="fa fa-check"></i> <?php echo esc_html($featuretitle); ?></li>
										<?php	
										}
									}
									}
									...
									if(!empty($subcaps)){
										foreach($subcaps as $key => $value){
											...
											echo '<li class="disable"><i class="fa fa-check"></i> '.strtoupper($featuretitle).'</li>';
											}
										}
									}
									?>
                            ...
                            <div class="sf-price-tb-plan">
                            	<?php if($billingperiod != '' && $packageprice != ''){ ?>
                                <div class="sf-price-plan-cost"><?php echo service_finder_currencysymbol(); ?><span><?php echo esc_html($packageprice); ?></span>/<?php echo esc_html($billingperiod); ?></div>
                                <?php }elseif($packageprice != ''){
								?>
								<div class="sf-price-plan-cost"><?php echo service_finder_currencysymbol(); ?><span><?php echo esc_html($packageprice); ?></span></div>
								<?php							
								}elseif($packageexpday != ''){ ?>
                                <div class="sf-price-plan-cost"><?php echo service_finder_currencysymbol(); ?><span><?php echo esc_html($packageprice); ?></span>/<?php echo esc_html($packageexpday).' '.esc_html__('Days','service-finder'); ?></div>
                                <?php } ?>
                            ...
                            if($signuptype == 'popup'){
                            ?>
                            <a class="sf-choose-plan-btn" href="javascript:;" data-action="signup" data-package="<?php echo esc_attr($packagenumber) ?> " data-redirect="no" data-toggle="modal" data-target="#login-Modal">
                                <?php echo esc_html__('Choose Plan','service-finder'); ?>
                            </a>
                            <?php
                            }else{
                            ?>
                            <a href="<?php echo esc_url($link); ?>" class="sf-choose-plan-btn"><?php echo esc_html__('Choose Plan','service-finder'); ?></a>
                            <?php
                            }
                            }
                            ?>
